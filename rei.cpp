...
int Rei::peca_no_caminho_torre(pos_atual_i,pos_atual_j, pos_final_i, pos_final_j, Tabuleiro *tabuleiro)
{
...
int Rei::peca_no_caminho_bispo(pos_atual_i,pos_atual_j, pos_final_i, pos_final_j, Tabuleiro *tabuleiro)
{
