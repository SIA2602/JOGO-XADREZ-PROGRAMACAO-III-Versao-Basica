...
int Peao::peca_no_caminho(int posicao_i, int posicao_j, int pos_final_i, int pos_final_j, Tabuleiro *tabuleiro)
{
   int x = posicao_j;
   int y = posicao_i;
   ...
   if(tabuleiro->getMatriz(pos_final_i, pos_final_j)!="0" && posicao_j==pos_final_j)
   {
      return 1;
   }
